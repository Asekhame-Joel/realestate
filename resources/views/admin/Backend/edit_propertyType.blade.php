                                ...
                                <div class="card rounded">
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="POST"
                                            action="{{ route('update.types', $propertyType->id) }}" >
                                            @csrf
                                            @method('PATCH')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="type_name" class="form-control
                                                 @error('type_name') is-invalid @enderror"
                                                    id="type_name" value="{{ old('type_name', $propertyType->type_name) }}">
                                                    @error('type_name')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="type_icon" name="type_icon" class="form-control"
                                                    id="type_icon" value="{{ old('type_name', $propertyType->type_icon) }}">
                                            </div>


                                            <button type="submit" class="btn btn-primary me-2">Update</button>
                                           <a href="{{route('all.types')}}" class="btn btn-danger me-2">Cancel</a>
