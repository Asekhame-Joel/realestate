                                ...
                                <div class="card rounded">
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="POST"
                                            action="{{ route('update.amenities', $amenities->id) }}" >
                                            @csrf
                                            @method('PATCH')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="amenities_name" class="form-control
                                                 @error('amenities_name') is-invalid @enderror"
                                                    id="amenities_name" value="{{ old('amenities_name', $amenities->amenities_name) }}">
                                           ...
                                           <a href="{{route('all.amenities')}}" class="btn btn-danger me-2">Cancel</a>
