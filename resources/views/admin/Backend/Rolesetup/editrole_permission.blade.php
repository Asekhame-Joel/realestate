                ...
                <div class="row profile-body">
                    ...
                    <div class="col-md-8 col-xl-8 middle-wrapper">
                        <div class="row">
                            <div class="col-md-12 grid-margin">
                                <div class="card rounded">
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="POST" action="{{route('updaterole.permission', $roles->id)}}">
                                            @csrf
                                            @if ($errors->any())
                                                <div>
                                                    <ul>
                          ...
                          {{ App\Models\User::roleHasPermission($roles, $permissionName) ? 'checked' : ''}}
                                                        ...
                                                        @foreach ($permissionName as $pn)
                                                            <div class="form-check mb-2 checkbox-group"
                                                                ...
                                                                <input type="checkbox"
                                                                    ...
                                                                    {{$roles->hasPermissionTo($pn->name) ? 'checked' : ''}}
                                                                    />
