                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="card rounded">
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="POST" action="{{route('UpdateAdmin', $profileData->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PATCH')
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="username" class="form-control" id="username"
                                                    autocomplete="off" value="{{ old('usernane', $profileData->username) }}" >
                                            </div>
                                                ...
                                                <select name="roles" class="form-select" id="roles">
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{{$role->name}}" 
                                                            {{$profileData->hasRole($role->name) ? 'selected' : ''}}>{{$role->name}}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
